---
title: "Base Stores: Local Synchronous State"
sidebarTitle: "Base Store"
description: "Base stores define local synchronous state with explicit update methods. They are the foundation of every Stores graph."
---
