---
title: "createQueryStore | Query Store Factory API Reference"
...
<ResponseField name="getQueryKey" type="(keyPayload: Record<string, unknown>) => string">
...
<ResponseField name="parseQueryKey" type="(queryKey: string) => Record<string, unknown>">
...
<ResponseField name="queryParam" type="(value, options: { key: false | ((value: T) => unknown) }) => QueryParamConfig">
...
<ResponseField name="defaultRetryDelay" type="(retryCount: number, options?: { baseDelay?: number; maxDelay?: number }) => number">
