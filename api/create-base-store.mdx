---
title: "createBaseStore API Reference"
...
<ParamField path="options" type="BaseStoreOptions<S, PersistedState, PersistReturn>">
  ...
  <Expandable title="PersistConfig fields">
    ...
    <ParamField path="sync" type="SyncConfig | string | true">
      Enables cross-tab or cross-context state synchronization. Pass `true` to inherit the sync key from `storageKey`, a plain string to use a custom key, or a `SyncConfig` object for full control.
    </ParamField>
  </Expandable>
</ParamField>
