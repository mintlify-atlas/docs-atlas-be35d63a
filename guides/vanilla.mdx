---
title: "Using Stores Without React (Vanilla Build)"
sidebarTitle: "Vanilla"
description: "Enable the vanilla build of @storesjs/stores to use reactive stores in non-React environments. Configure the vanilla package condition and use the plain store API."
---
...
await settingsStore.persist.hasHydrated();
